...
public class RedisUtil {
    ...
    public Set<ZSetOperations.TypedTuple<String>> getReverseRangeWithScores(String key, long start, long end) {
        try {
            Set<ZSetOperations.TypedTuple<Object>> tuples = redisTemplate.opsForZSet().reverseRangeWithScores(key, start, end);
            Set<ZSetOperations.TypedTuple<String>> tuplesStr = new HashSet<>();
